...
void main()
{
    ...
    vec3 modelPositionA = modelPosition.xyz + vec3 (shift, 0.0, 0.0); // also modelPositionA.x += shift;
    vec3 modelPositionB = modelPosition.xyz + vec3 (0.0, 0.0, - shift); // also modelPositionA.z += shift;
